  ...
  home: [
    {
      targets: ["nav-home"],
      title: "Главная",
      text: "Цех сегодня: продажи, долги, прибыль и что сейчас делается на производстве.",
    },
    {
      targets: ["tour-lang"],
      title: "Язык",
    ...
    },
    {
      targets: ["nav-search"],
      title: "Поиск",
      text: "Значок слева в шапке. Нажмите — поле откроется. Ищите заказ, клиента или изделие.",
    },
    {
      targets: ["home-kpis"],
      title: "Цифры",
      text: "Каждая карточка — показатель. Нажмите её, чтобы открыть нужный раздел.",
    },
    {
      targets: ["home-work"],
      title: "Что требует внимания",
      text: "Задания в работе. Жёлтые блоки — опоздание заказа или сырьё ниже минимума.",
    },
  ],
  products: [
    {
  ...
  home: [
    {
      targets: ["nav-home"],
      title: "Асосӣ",
      text: "Имрӯз дар корхона: фурӯш, қарз, фоида ва кори истеҳсолот.",
    },
    {
      targets: ["tour-lang"],
      title: "Забон",
    ...
    },
    {
      targets: ["nav-search"],
      title: "Ҷустуҷӯ",
      text: "Нишона дар чапи сарлавҳа. Пахш кунед — майдон кушода мешавад. Фармоиш, мизоҷ ё мол.",
    },
    {
      targets: ["home-kpis"],
      title: "Рақамҳо",
      text: "Ҳар карта — нишондиҳанда. Пахш кунед — бахш кушода мешавад.",
    },
    {
      targets: ["home-work"],
      title: "Диққат",
      text: "Вазифаҳои кушода. Блоки зард — фармоиши дер ё ашёи кам.",
    },
  ],
  products: [
    {
