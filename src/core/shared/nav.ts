...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    id: "company",
    labelKey: "nav.org",
    items: [EMPLOYEES_ITEM, ANALYTICS_ITEM, SETTINGS_ITEM],
  },
];
...
function rawTabsForRole(roleCode: string): BottomTab[] {
  switch (roleCode) {
    ...
    case "sales_manager":
      return [HOME_ITEM, CRM_ITEM, ORDERS_ITEM, COMMISSION_ITEM];
    case "production_manager":
      return [HOME_ITEM, BATCHES_ITEM, SCRAP_ITEM];
    case "warehouse_manager":
      return [HOME_ITEM, WAREHOUSE_ITEM, PURCHASING_ITEM, INVENTORY_ITEM];
    case "accountant":
