...
const ruTour: Record<HelpPageId, TourStep[]> = {
  ...
  products: [
    ...
    },
    {
      ...
      text: "«Рецепт на» — обычно 1. «Выходит штук» — сколько плиток с этого рецепта. «Цена клиенту» и «Дешевле нельзя» — продажа.",
    },
    {
...
const tjTour: Record<HelpPageId, TourStep[]> = {
  ...
  products: [
    ...
    },
    {
      ...
      text: "«Рецепт барои» — одатан 1. «Мебарояд дона» — чанд плитка. «Нарх ба мизоҷ» ва «Арзонтар наметавон» — фурӯш.",
    },
    {
      targets: ["products-list"],
      title: "Рӯйхат",
