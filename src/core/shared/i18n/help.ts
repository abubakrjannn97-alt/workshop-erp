...
const ruTour: Record<HelpPageId, TourStep[]> = {
  ...
  analytics: [
    ...
    },
    {
      targets: ["an-kpis"],
      title: "Показатели",
      text: "Карточки сверху — маржа, прибыль, запас сырья и брак. Таблица ниже — какие изделия выгодны.",
    },
  ],
  settings: [
    {
...
const tjTour: Record<HelpPageId, TourStep[]> = {
  ...
  analytics: [
    ...
    },
    {
      ...
      text: "Картаҳо — маржа, фоида, захираи ашё ва нуқсон. Ҷадвал — кадом мол фоиданок.",
    },
  ],
  settings: [
    {
