...
const ruTour: Record<HelpPageId, TourStep[]> = {
  ...
  products: [
    ...
    },
    {
      ...
      title: "Новое изделие",
      text: "Шаг 1: имя, единицы и фото. Шаг 2: сырьё в рецепте — система считает расход, потом цена клиенту и «дешевле нельзя».",
    },
    {
  ...
  crm: [
    {
      targets: ["nav-crm"],
      title: "Клиенты",
      text: "База клиентов: карточки, телефоны, заказы и долги.",
    },
    {
      targets: ["crm-new"],
      title: "Новый клиент",
      text: "Нажмите «+», заполните ФИО и телефон. Источник — по желанию.",
    },
    {
      targets: ["crm-customers"],
      title: "Список клиентов",
      text: "Можно скрыть или показать. Откройте карточку — там заказы и долг.",
    },
  ],
  orders: [
    {
  ...
  purchasing: [
    {
      ...
      title: "Закупки",
      text: "Отчёт и история закупок за неделю или месяц.",
    },
    {
      targets: ["po-period"],
      title: "Неделя / месяц",
      text: "Переключите период — сумма и список обновятся.",
    },
    {
      targets: ["po-report"],
      title: "Отчёт",
      text: "Общая сумма закупок за выбранный период, оплачено и долг.",
    },
    {
      targets: ["po-history"],
      title: "История",
      text: "Все заявки за период. Откройте карточку, чтобы принять или оплатить.",
    },
  ],
  finance: [
    {
...
const tjTour: Record<HelpPageId, TourStep[]> = {
  ...
  products: [
    ...
    },
    {
      targets: ["products-form"],
      title: "Моли нав",
      text: "Қадам 1: ном, воҳид ва акс. Қадам 2: ашё дар рецепт — хароҷот ҳисоб мешавад, баъд нарх ба мизоҷ.",
    },
    {
      targets: ["products-list"],
      title: "Рӯйхат",
  ...
  crm: [
    {
      targets: ["nav-crm"],
      title: "Мизоҷон",
      text: "Базаи мизоҷон: кортҳо, телефон, фармоиш ва қарз.",
    },
    {
      targets: ["crm-new"],
      title: "Мизоҷи нав",
      text: "«+»-ро пахш кунед, ном ва телефонро нависед. Манбаъ — ихтиёрӣ.",
    },
    {
      targets: ["crm-customers"],
      title: "Рӯйхати мизоҷон",
      text: "Пинҳон ё нишон додан мумкин. Кортро кушоед — фармоиш ва қарз.",
    },
  ],
  orders: [
    {
  ...
  purchasing: [
    {
      targets: ["nav-purchasing"],
      title: "Харид",
      text: "Ҳисобот ва таърихи харид барои ҳафта ё моҳ.",
    },
    {
      targets: ["po-period"],
      title: "Ҳафта / моҳ",
      text: "Давраро иваз кунед — ҷамъ ва рӯйхат нав мешавад.",
    },
    {
      targets: ["po-report"],
      title: "Ҳисобот",
      text: "Ҷамъи харидҳои давра, пардохт ва қарз.",
    },
    {
      targets: ["po-history"],
      title: "Таърих",
      text: "Ҳамаи дархостҳои давра. Кортро кушоед — қабул ё пардохт.",
    },
  ],
  finance: [
    {
