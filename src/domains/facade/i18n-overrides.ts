...
export const FACADE_I18N_OVERRIDES: Record<Locale, Dict> = {
  ru: {
    ...
    "products.recipeBaseSimple": "Сырьё считать на, м²",
    "products.outputSimple": "Плиток с 1 м²",
    "products.minPriceSimple": "Не дешевле, с",
    "products.minStockSimple": "Мало, если меньше шт",
    "products.maxStockSimple": "Много, если больше шт",
    ...
    "products.maxStockHint": "Если плиток станет больше — предупреждение на складе. 0 = без лимита",
    "products.minStock": "Минимум на складе, шт",
    "products.minStockHint": "Если остаток станет меньше — система предупредит",
    "products.minPrice": "Минимальная цена, с",
    "products.minPriceHint": "Ниже этой цены продать нельзя",
  ...
  tj: {
    ...
    "products.recipeBaseSimple": "Ашё барои, м²",
    "products.outputSimple": "Плитка аз 1 м²",
    "products.minPriceSimple": "Арзонтар не, с",
    "products.minStockSimple": "Кам, агар камтар дона",
    "products.maxStockSimple": "Зиёд, агар зиёдтар дона",
    "products.groupBasic": "Ном",
    "products.groupMake": "Фурӯш ва истеҳсол",
    "products.groupStock": "Нарх ва анбор",
    "products.maxStock": "Максимум дар анбор, дона",
    "products.maxStockHint": "Агар зиёд шавад — огоҳӣ дар анбор. 0 = бе лимит",
    "products.minStock": "Минимум дар анбор, дона",
    "products.minStockHint": "Агар бақия камтар шавад — система огоҳ мекунад",
