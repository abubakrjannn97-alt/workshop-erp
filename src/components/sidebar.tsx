...
function NavLink({
  ...
  return (
    ...
    >
      <Icon size={20} strokeWidth={ICON_STROKE} className={styles.icon} aria-hidden />
  ...
  return (
    ...
    >
      <div className={`${styles.brand} ${collapsed ? styles.brandCollapsed : ""}`}>
        ...
        >
          <ChevronsLeft size={20} strokeWidth={ICON_STROKE} className={collapsed ? "rotate-180" : undefined} aria-hidden />
        </button>
      </div>
